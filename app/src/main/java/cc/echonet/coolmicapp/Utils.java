...
public class Utils {
    ...
    public static void loadCMTSData(Activity activity, String profileName) {
        ...
        editor.putString("connection_address", activity.getString(R.string.pref_default_connection_address_my));
        editor.putString("connection_username", activity.getString(R.string.pref_default_connection_username_my));
        editor.putString("connection_password", activity.getString(R.string.pref_default_connection_password_my));
        ...
        System.err.println("random data "+randomComponent);
