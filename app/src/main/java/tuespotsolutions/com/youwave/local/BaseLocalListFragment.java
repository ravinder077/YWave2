...
import tuespotsolutions.com.youwave.fragments.list.ListViewContract;
...
public abstract class BaseLocalListFragment<I, N> extends BaseStateFragment<I>
    ...
    protected View getListFooter() {
        return activity.getLayoutInflater().inflate(tuespotsolutions.com.youwave.R.layout.pignate_footer, itemsList, false);
    }
