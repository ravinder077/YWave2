...
import tuespotsolutions.com.youwave.ReCaptchaActivity;
import tuespotsolutions.com.youwave.extractor.Info;
import tuespotsolutions.com.youwave.extractor.NewPipe;
import tuespotsolutions.com.youwave.extractor.channel.ChannelInfo;
import tuespotsolutions.com.youwave.extractor.exceptions.ContentNotAvailableException;
import tuespotsolutions.com.youwave.extractor.exceptions.ParsingException;
import tuespotsolutions.com.youwave.extractor.exceptions.ReCaptchaException;
import tuespotsolutions.com.youwave.extractor.kiosk.KioskInfo;
import tuespotsolutions.com.youwave.extractor.playlist.PlaylistInfo;
import tuespotsolutions.com.youwave.extractor.search.SearchInfo;
import tuespotsolutions.com.youwave.extractor.services.youtube.extractors.YoutubeStreamExtractor;
import tuespotsolutions.com.youwave.extractor.stream.StreamInfo;
import tuespotsolutions.com.youwave.report.ErrorActivity;
...
import tuespotsolutions.com.youwave.extractor.ListExtractor;
...
public final class ExtractorHelper {
    ...
    public static Single<ListExtractor.InfoItemsPage> getMorePlaylistItems(final int serviceId,
                                                                           final String url,
                                                                           final String nextStreamsUrl) {
        checkServiceId(serviceId);
        return Single.fromCallable(() ->
    ...
    public static Single<ListExtractor.InfoItemsPage> getMoreKioskItems(final int serviceId,
                                                                        final String url,
                                                                        final String nextStreamsUrl,
                                                                        final String contentCountry) {
        return Single.fromCallable(() ->
